<div id="posts" style ="background-color:#e6e0de;">
    <div>
        <?php
...
echo "</a>";
        ...
        ?>
        <a href="<?=ROOT?>like/post/<?php echo $COMMENT['postid']; ?>">Like<?php echo $likes ?></a> .  <span style="color:#999;"><?php echo $COMMENT['date']; ?></span>
        <?php
        ...
        if ($COMMENT['likes'] > 0) {
            ...
            if ($COMMENT['likes'] == 1) {
                if ($i_liked) {
                    ...
                    echo  "<span style='float:left;'>1 person liked this comment </span>";
                }
            } else {
                if ($i_liked) {
                    ...
                    if($COMMENT['likes'] -1 == 1){
                        ...
                        echo  "<span style='float:left;'>You and 1 other liked this comment </span>";
                    }else 
                    {
                        echo  "<span style='float:left;'>You and " . $COMMENT['likes'] . " others liked this comment </span>";    
                    }
                } else {
