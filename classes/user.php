...
class User
{
    ...
    public function follow_user($id, $type, $mybook_userid)
    {
            ...
            //save likes details
            $sql = "select following from likes where following != '' && type = '$type' && contentid = '$mybook_userid' limit 1";
            $result = $DB->read($sql);
    ...
    public function get_following($id, $type)
    {
        ...
        if (is_numeric($id)) {
            ...
            $sql = "select following from likes where following != '' && type = '$type' && contentid = '$id'  limit 10
            ";
            $result = $DB->read($sql);
