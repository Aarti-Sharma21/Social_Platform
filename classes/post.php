...
class Post
{
    ...
    public function delete_post($postid)
    {
        ...
        $DB->save($query);
        $query = "delete from notifications where contentid = '$postid' limit 1";
    ...
    public function like_post($id, $type, $mybook_userid)
    {
        ...
        //save likes details
        $sql = "select likes from likes where likes != '' && type = '$type' && contentid = '$id' limit 1";
        $result = $DB->read($sql);
