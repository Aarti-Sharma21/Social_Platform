 ...
 <div id="blue_bar">
     <form method="post" action="<?=ROOT?>search/">
         <div style="width:800px; margin:auto; font-size:30px;">
             ...
             &nbsp &nbsp <input type="text" id="search_box" placeholder="Search for people" name="find">
             <?php if (isset($USER) || isset($_POST['find'])) : ?>
                 <a href="<?=ROOT?>profile">
                 ...
                 <a href="<?=ROOT?>notifications">
                     <span style="display:inline-block;position:relative;">
                         ...
                         <?php if ($notif > 0) : ?>
                             <div style="background-color:red;color:white;position:absolute;right:-15px;width:15px;height:15px;border-radius:50%;padding:4px;text-align:center;font-size:14px;"><?=$notif?></div>
                         <?php endif; ?>
                     </span>
                 </a>
             ...
             <?php else : ?>
                 <a href="<?=ROOT?>login">
                     <span style="font-size:13px; float:right; margin:10px; color:white;">Log in</span>
                 </a>
             <?php endif; ?>
         </div>
     </form>
