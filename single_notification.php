...
$DB = new Database();
        ...
        if (is_array($actor) && is_array($owner)) {
            ...
            if ($notif_row['activity'] == "like") {
                ...
                else if ($notif_row['activity'] == "role") {
                    echo " changed your access to ";
                }
                else if ($notif_row['activity'] == "invite") {
                    echo " invited you to ";
                }
            }
            ...
            if ($notif_row['content_type'] == "post") {
                ...
                echo "
                        <span style ='float:right;font-size:12px;color:#888;display:inline-block;margin-right:10px;'>" . htmlspecialchars(substr($content_row['post'], 0, 50)) . "</span>";
